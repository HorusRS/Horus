...
pub fn run_signatures(signatures: &HashMap<sig::SignatureHash, sig::SignatureEntry>) {
...
fn get_boot_time() -> DateTime<Utc> {
	...
	DateTime::<Utc>::from_utc(NaiveDateTime::from_timestamp(boot_time as i64, 0), Utc)
}
